...
CREATE TABLE `permission_definitions`  (
  `ID` int NOT NULL AUTO_INCREMENT,
  `Module` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `permission_definitions` VALUES (1, 'User', 'Profile', NULL);
...
CREATE TABLE `sys_permission_definitions`  (
  ...
  `Submodule_Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Label` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Actions` json NOT NULL,
  PRIMARY KEY (`ID`) USING BTREE,
  UNIQUE INDEX `Module_Name`(`Module_Name`, `Submodule_Name`, `Label`) USING BTREE
...
-- ----------------------------
INSERT INTO `sys_users` VALUES (1, '1c4ca4238a0', '2022-01-04 13:46:35', '2022-04-30', 'Muhittin Yendun', 'm', 'bbb', NULL, NULL, 'avatar', 'Botany', NULL, 1, 0, NULL);
INSERT INTO `sys_users` VALUES (2, '2c81e728d9d', '2022-01-06 14:51:45', '2022-04-30', 'Muhittin Yendun2', 'ma', '1a', NULL, NULL, '', 'Botany', NULL, 1, 0, NULL);
INSERT INTO `sys_users` VALUES (3, '3eccbc87e4b', '2022-01-07 10:28:32', '2022-04-30', 'Username Userlastname', 'aaa', '$2a$10$YlTTb6NYNj6ybyAE28XmZO7t.rgEseN8VZQeoIw7jIp/kVNg3VLqi', '111', '$2a$10$YlTTb6NYNj6ybyAE28XmZO', '', 'Botany', NULL, 1, 0, NULL);
INSERT INTO `sys_users` VALUES (5, '5e4da3b7fbb', '2022-03-11 13:36:28', '2023-04-30', 'Muhittin Yendun', 'muhittin.yendun@au.indorama.net', '$2a$10$GVMNS83kr6bD/8l2ZAqLbuwowHfThgLMW5OsTmYj6l8p3VX1hUHjm', '111', '$2a$10$GVMNS83kr6bD/8l2ZAqLbu', 'profileimage.jfif', 'Botany', '/', 1, 0, '{\"user\": {\"type\": \"Global admin\"}}');
INSERT INTO `sys_users` VALUES (6, '61679091c5a', '2023-04-21 14:16:00', '2023-04-21', 'Drawings', 'drawings', '$2a$10$YlTTb6NYNj6ybyAE28XmZO7t.rgEseN8VZQeoIw7jIp/kVNg3VLqi', '2022', '$2a$10$YlTTb6NYNj6ybyAE28XmZO', 'a', 'Botany', '/drawings', 1, 0, NULL);
